---
title: "How did the universe get so dusty?"
date: "2011-08-08"
pin: false
...
*This post originally appeared on Astrobites.org on August 08, 2011 at [https://astrobites.org/2011/08/08/how-did-the-universe-get-so-dusty/](https://astrobites.org/2011/08/08/how-did-the-universe-get-so-dusty/).*

**Title**: [Production of dust by massive stars at high redshift](https://arxiv.org/abs/1108.0403)
**Authors**: C. Gall, J. Hjorth, A. C. Andersen
**First Author's Institution:** The Dark Cosmology Centre, Niels Bohr Institute, University of Copenhagen, Denmark

[![](https://astrobites.org/wp-content/uploads/2011/08/gall4.png?w=248)](https://astrobites.org/wp-content/uploads/2011/08/gall4.png)
...
In their new review, Gall et al. consider the observed existence of very dusty (dust mass > 108 M☉) [submillimeter galaxies and quasars](https://astrobites.com/glossaries/galaxy-and-agn-types/) at high redshift.  At this redshift (z>6), the universe was less than a Gyr old and it was just a few hundred Myr after [stars started forming](https://astrobites.com/2011/05/02/bosss-3d-map-of-the-early-universe/).  The authors address the question, "how did these galaxies get so dusty so soon?" Understanding dust is important, because we need to model the [dimming and reddening effects of dust](https://en.wikipedia.org/wiki/Extinction_(astronomy)) in order to interpret almost any astronomical observations.

The obvious culprit is core-collapse supernovae (SNe). We know that [SNe can synthesize](https://astrobites.com/2010/12/27/origin-of-the-chemical-elements-2/) enormous amounts (of order M☉) of Ni and other heavy elements, of which astrophysical dust is composed. Applying models of dust formation (and lots of assumptions) to the conditions of SN ejecta has predicted that ~M☉ of dust should emerge within a few years of the explosion However, observations of attenuation in spectral lines or infrared emission from SNe suggests masses ~104x smaller.

[Ian's recent Astrobite](https://astrobites.com/2011/08/04/dusty-supernovae/) highlighted these observational methods and discussed new work illustrating that, at least for some types of SNe, the progenitor star probably produces more dust than the explosion. Most stars don't lose much of their mass, though, so they probably won't contribute much to dust enrichment unless they have reached the [Asymptotic Giant Branch (AGB)](https://en.wikipedia.org/wiki/Asymptotic_giant_branch) stage near the ends of their lives.
...
So who is the more important dust producer in the early universe — AGB stars or SNe? To answer this, we need to know about the dust-production characteristics of these processes, and also their abundance in galaxies. The abundances are largely determined by [the initial mass function (IMF)](https://astronomy.nmsu.edu/holtz/talks/potsdam03/colloq/node2.html). Today, the IMF is bottom-heavy (low-mass stars are more common), but in the early universe we think it was much more top-heavy. This is important, because a Gyr after the Big Bang, only stars with mass greater than ~3 M☉ will have reached the AGB stage — and only stars more than twice that massive will produce core-collapse SNe.
