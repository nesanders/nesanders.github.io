...
tags: [astrophysics, exoplanets, spectroscopy]
venue: "Astrobites"
...
**Title**: [The Flat Transmission Spectrum of the Super-Earth GJ1214b from Wide Field Camera 3 on the Hubble Space Telescope](https://arxiv.org/abs/1111.5621)
...
The final version of those results has just been released in a paper accepted by the Astrophysical Journal.  Berta et al. report on [HST WFC3](https://www.stsci.edu/hst/wfc3) observations of the transiting planet.  Their paper includes a very detailed analysis of the performance and systematics of the [slitless spectroscopy mode of WFC3](https://www.arcetri.astro.it/confraef/pdf/McCarthy_Perugia.pdf) that affect transmission spectroscopy.  A laundry list of effects need to be considered, including stellar limb darkening and image persistence.  The authors assemble a model accounting for each of these effects and see how the best-fit parameters of the model vary using [MCMC](https://astrobites.com/2011/11/26/your-gateway-to-the-bayesian-realm/) methods.  Over three different HST observations, the systematics parameters hardly change, meaning that they can be corrected for reliably.
