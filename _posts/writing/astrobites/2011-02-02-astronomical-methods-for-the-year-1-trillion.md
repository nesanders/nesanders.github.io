...
Update: you can read Avi Loeb and Freeman Dyson's discussion of this issue in [our latest post](https://astroph.wordpress.com/2011/02/03/avi-loeb-and-freeman-dyson-on-the-future-of-the-universe/).
...
What's more, the accelerating expansion of the universe predicted by the standard [ΛCDM cosmology](https://www.astro.ucla.edu/~wright/cosmo_01.htm) has redshifted the photons of the [cosmic microwave background](https://map.gsfc.nasa.gov/universe/bb_tests_cmb.html) beyond the event horizon of the entire future universe, so future [BOOMERANG](https://cmb.phys.cwru.edu/boomerang/) or [WMAP](https://wmap.gsfc.nasa.gov/) experiments will not work.  

Clearly, these future observers could not use the same tools we have to understand the origins of the universe.  Fortunately, Harvard Professor [Avi Loeb](https://cfa-www.harvard.edu/~loeb/) has a [very interesting short paper](https://arxiv.org/abs/1102.0007) on the arXiv today that speculates on the tools astronomers living a trillion years in the future could use to infer the standard model of cosmology we have derived from present-day observations of the universe.
