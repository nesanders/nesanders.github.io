...
tags: [open source software, linux, ssh, free software magazine]
description: A 2007 Free Software Magazine article about running Linux GUI software on Windowx by tunneling over SSH X11 forwarding.
# image:
#   path:
#  alt:
---
...
> You can use your Xming USB stick with any Windows machine running XP or later
...
![Figure 2: Yes, this is Amarok running on Windows. Don’t get too excited, though; all the sound still plays out of my Ubuntu machine downstairs.]({{"/assets/img/writing/2007_fsm_run_gnulinux_apps_on_windows_no_virtualization/Amarok.jpg" | relative_url }})
*Figure 2: Yes, this is Amarok running on Windows. Don’t get too excited, though; all the sound still plays out of my Ubuntu machine downstairs.*
...
![Figure 3: PuTTY is a wonderful and powerful application, but it is far more simple to launch remote programs with plink—even if it means using the command line.]({{"/assets/img/writing/2007_fsm_run_gnulinux_apps_on_windows_no_virtualization/Putty.jpg" | relative_url }})
*Figure 3: PuTTY is a wonderful and powerful application, but it is far more simple to launch remote programs with plink—even if it means using the command line.*
